...
if (getRversion() < "3.0.0") {
    ...
    fix_External2(.basename2_windows)
    fix_External2(.basename2_unix)
    fix_External2(basename2)
    fix_External2(.dirname2_windows)
    fix_External2(.dirname2_unix)
    fix_External2(dirname2)
    fix_External2(.splitext_windows)
    fix_External2(.splitext_unix)
    fix_External2(splitext)
    fix_External2(.removeext_windows)
    fix_External2(.removeext_unix)
    fix_External2(removeext)
    fix_External2(.ext_windows)
    fix_External2(.ext_unix)
    fix_External2(ext)
    fix_External2(`.ext_windows<-`)
    fix_External2(`.ext_unix<-`)
    fix_External2(`ext<-`)
    fix_External2(.path_join_windows)
    fix_External2(.path_join_unix)
    fix_External2(path.join)
    fix_External2(.path_split_windows)
    fix_External2(.path_split_unix)
    fix_External2(path.split)
    fix_External2(.path_split_1_windows)
    fix_External2(.path_split_1_unix)
    fix_External2(path.split.1)
    fix_External2(.path_unsplit_windows)
    fix_External2(.path_unsplit_unix)
    fix_External2(path.unsplit)
    fix_External2(.is_abs_path)
    fix_External2(.splitroot_windows)
    fix_External2(.splitroot_unix)
    fix_External2(.splitroot)
    fix_External2(.splitdrive_windows)
    fix_External2(.splitdrive_unix)
    fix_External2(.splitdrive)
